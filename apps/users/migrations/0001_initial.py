# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2017-12-21 05:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=1, verbose_name='访问顺序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '注册'), ('forget', '找回密码'), ('update', '修改邮箱')], max_length=10, verbose_name='发送类型')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '邮箱验证',
